...
<div class="panel panel-primary">
	<div class="panel-heading">
		<h1 class="panel-title"><?php echo __('ユーザー編集');?></h1>
	</div>
	<div class="panel-body">
<?php echo $this->Form->create('Post'); ?>

<div class="form-group">
	<label for="id" class="control-label"><?php echo __('ユーザーID'); ?></label>
<p class="form-control-static"><?php echo $this->request->data['User']['id']."\n"; ?></p>
...
<?php echo $this->Form->text("User.localLoginPassword", array('class'=>'form-control','type' => 'password'))."\n"; ?><br />
<?php echo $this->Form->error("User.localLoginPassword")."\n"; ?><br />
<?php echo $this->Form->hidden("User.localLoginPassword_old", array('value' => $this->request->data["User"]["localLoginPassword"]))."\n"; ?>
</div>

<div class="form-group">
	<div class="checkbox">
<?php echo $this->Form->checkbox("User.allowLocalLogin",array('class'=>'form-control')); ?>
	</div>
...
<?php echo $this->Form->text("User.penID",array('class'=>'form-control'))."\n"; ?><br />
<?php echo $this->Form->error("User.penID")."\n"; ?>
</div>
<div class="form-group">
	<div class="checkbox">
<?php echo $this->Form->checkbox("User.available",array('class'=>'form-control')); ?>
	</div>
