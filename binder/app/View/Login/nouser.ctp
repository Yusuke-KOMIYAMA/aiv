...
<head>
    ...
    <title translate="login.nouser.title"></title>
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" class="nouser">

            <div class="container">

                <div class="row" style="padding-top:10px;">
                    <div class="col-md-12">
                        <div class="alert alert-warning" role="alert" translate="login.nouser.message"></div>
                        <a href="<?php echo $this->Html->url('/login/', true); ?>" translate="login.nouser.link"></a>
                    </div>
                </div>
